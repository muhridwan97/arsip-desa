        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/suratmasuk"  enctype="multipart/form-data" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <hr>
                    <a href="users/suratmasuk" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/suratmasuk') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/suratmasuk/t";
                //     }
                // });
